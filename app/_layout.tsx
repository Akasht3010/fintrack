...
function RootLayoutNav() {
  ...
  return (
    // Desktop-web layout lives per route group instead of here: (auth) frames
    // itself as a centered card (see app/(auth)/_layout.tsx), (tabs) grows a
    // sidebar (see app/(tabs)/_layout.tsx), and (modals) centers as a dialog
    // (see app/(modals)/_layout.tsx) — a single wrapper here would nest all
    // three inside one box, which is exactly the "whole site trapped in a
    // card" look those group layouts exist to avoid.
