...
export default function BudgetScreen() {
  ...
  const trashColor = isDark ? "#9ca3af" : Colors.muted
            ...
            {budgets.map((budget) => {
              ...
              return (
                ...
                >
                  ...
                  <View className="h-2 rounded-full bg-neutral-100 dark:bg-white/10 overflow-hidden mb-2">
                    <View
                      style={{ width: `${percent}%` }}
                      className={`h-full rounded-full ${isOver ? "bg-red-500" : "bg-primary-600 dark:bg-accent-500"}`}
                    />
                  </View>
